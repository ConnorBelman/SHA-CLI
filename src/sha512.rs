...
const H1_0: u64 = 0xBB67AE8584CAA73B; 
const H2_0: u64 = 0x3C6EF372FE94F82B;
const H3_0: u64 = 0xA54FF53A5F1D36F1;
const H4_0: u64 = 0x510E527FADE682D1;
const H5_0: u64 = 0x9B05688C2B3E6C1F;
const H6_0: u64 = 0x1F83D9ABFB41BD6B;
const H7_0: u64 = 0x5BE0CD19137E2179;
...
pub fn generate(message: String) -> String {
	...
	let digest = format!("{:0>16X}{:0>16X}{:0>16X}{:0>16X}{:0>16X}{:0>16X}{:0>16X}{:0>16X}", h[0], h[1], h[2], h[3], h[4], h[5], h[6], h[7]);
	digest
}