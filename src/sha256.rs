...
const H1_0: u32 = 0xBB67AE85;
const H2_0: u32 = 0x3C6EF372;
const H3_0: u32 = 0xA54FF53A;
const H4_0: u32 = 0x510E527F;
const H5_0: u32 = 0x9B05688C;
const H6_0: u32 = 0x1F83D9AB;
const H7_0: u32 = 0x5BE0CD19;
...
pub fn generate(message: String) -> String {
	...
	let digest = format!("{:0>8X}{:0>8X}{:0>8X}{:0>8X}{:0>8X}{:0>8X}{:0>8X}{:0>8X}", h[0], h[1], h[2], h[3], h[4], h[5], h[6], h[7]);
	digest
}
